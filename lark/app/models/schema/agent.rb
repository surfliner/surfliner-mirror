...
module Schema
  ##
  # Dynamically generate the attributes for the Agent model basing on the
  # structure data in model definition lark/model/agents.yaml
  module Agent
    extend ActiveSupport::Concern

    included do
      model_file = File.expand_path('../../../model/agents.yml', __dir__)
