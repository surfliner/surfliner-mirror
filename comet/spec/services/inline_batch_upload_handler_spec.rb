...
RSpec.describe InlineBatchUploadHandler, storage_adapter: :memory do
  ...
  let(:local_file) { BatchUploadsControllerBehavior::StagingAreaFile.new(path: File.dirname(file), filename: File.basename(file)) }
