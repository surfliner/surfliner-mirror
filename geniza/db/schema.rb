...
ActiveRecord::Schema.define(version: 20_180_712_191_612) do
  ...
  create_table 'spotlight_roles', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id user_id], name: 'index_spotlight_roles_on_resource_and_user_id', unique: true
  end
